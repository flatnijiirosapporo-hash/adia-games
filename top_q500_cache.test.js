...
for(const g of games){
 ...
 if(g.href){ const special={moonJump:'v=20260903-jumpfix1',worldTripJump:'v=20260903-jumpfix1'}; const expectedVersion=special[g.id]||`v=${V}`; assert.ok(g.href.includes(expectedVersion),`${g.id}: direct href version unexpected (${g.href})`); }
}
