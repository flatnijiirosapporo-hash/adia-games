...
assert.ok(moon.href.startsWith('moon_jump.html?v=20260903-jumptune1'),'moonJump must link to cache-busted moon_jump.html');
...
assert.match(index,/href="moon_jump\.html\?v=20260903-jumptune1"/,'TOP must use the moon game cache version');
