...
assert.ok(moon.href.startsWith('moon_jump.html?v=20260903-jumpfix1'),'moonJump must link to cache-busted moon_jump.html');
...
assert.match(index,/href="moon_jump\.html\?v=20260903-jumpfix1"/,'TOP must use the moon game cache version');
