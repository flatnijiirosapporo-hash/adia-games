...
assert.strictEqual(games.length, 84, 'TOP main catalog must contain 84 one-card games');
const expected = [
  ...
  ['sstHub','SST','sst.html'],
  ['numberHighLow','数字ハイアンドロー','number_highlow.html']
];
...
assert.match(index,/<span id="gameCount">84<\/span>種類/,'visible initial game count must be 84');
...
console.log('PASS top unified 84 games');
